...
public class HomeActivity extends AppCompatActivity implements Response.Listener<String>, Response.ErrorListener {

    public static final String LOG_TAG = "Esta es la Url";
    public static final String URL_TOP_TRACKS = "http://ws.audioscrobbler.com/2.0/?method=chart.gettoptracks&api_key=e92bf3484746b8a87ba97aee608b9b8b&format=json";
    ...
    protected void onResume() {
        ...
        //La peticion
        StringRequest topTracks = new StringRequest(Request.Method.GET,
    ...
    public ArrayList<Track> parseTracksArray(String response)  throws JSONException{
